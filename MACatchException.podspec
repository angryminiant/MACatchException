...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "AngryMiniAnt" => "angryminiant@163.com" }
  # Or just: spec.author    = ""
  # spec.authors            = { "" => "" }
  ...
  spec.source       = { :git => "https://github.com/angryminiant/MACatchException.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "MACatchException/**/*.{h,m}"
